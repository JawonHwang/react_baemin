    ...
    return (
        <div className={style.container}>
            ...
            <div className="card p-fluid">
                <DataTable value={products}  size={'small'} editMode="row" dataKey="joId" tableStyle={{ minWidth: '100rem' }} globalFilter={globalFilter} paginator rowsPerPageOptions={[5, 10, 25]} rows={10}>
