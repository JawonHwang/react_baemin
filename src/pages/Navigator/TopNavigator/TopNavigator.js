                        ...
                        {/* {
                            loginID ? */}
                                {/* <> */}
                                    ...
                                    <Col>
                                        <Link className={styles.linkurl} to="/baemin/Board"><div className={activeLink === 'Board' ? styles.activeLink : styles.linkurl} onClick={() => handleLinkClick('Board')}>BOARD</div></Link>
                                    </Col>
                                    <Col>
                                        <Link className={styles.linkurl} to={`/baemin/Calendar`}><div>CALENDAR</div></Link>
                                    </Col>
                                    <Col>
                                        <Link className={styles.linkurl} to={`/baemin/Community`}><div>COMMUNITY</div></Link>
                                    </Col>
                                    <Col>
                                        <Link className={styles.linkurl} to={`/baemin/MyPage`}><div>MY PAGE</div></Link>
                                    </Col>
                                    <Col>
                                ...
                                <> */}
                                    ...
                                    <Col>
                                        <Link className={styles.linkurl} onClick={handleRegisterClick}><div className={activeLink === 'Register' ? styles.activeLink : styles.linkurl} onClick={() => handleLinkClick('Register')}>REGISTER</div></Link>
                                    </Col>
                                {/* </> */}
                        {/* } */}
                    </Row>
                ...
                content={({ hide }) => (
                    <div className="flex flex-column px-8 py-5 gap-4" style={{ borderRadius: '12px', backgroundImage: 'radial-gradient(circle at left top, var(--primary-400), var(--primary-700))' }}>
                        ...
                        <div className="inline-flex flex-column gap-2">
                            <label htmlFor="ID" className="text-primary-50 font-semibold">
                                ID
                            </label>
                            <InputText id="ID" value={MemId} onChange={(e) => setMemId(e.target.value)} className="bg-white-alpha-20 border-none p-3 text-primary-50" />
                        </div>
                        <div className="inline-flex flex-column gap-2">
                            <label htmlFor="PW" className="text-primary-50 font-semibold">
                                PW
                            </label>
                            <InputText id="PW" type="password" value={MemPw} onChange={(e) => setMemPw(e.target.value)} className="bg-white-alpha-20 border-none p-3 text-primary-50" />
                        </div>
                        <div className="flex align-items-center gap-2">
                            <Button label="Sign-In" onClick={handleSignIn} text className="p-3 w-full text-primary-50 border-1 border-white-alpha-30 hover:bg-white-alpha-10" />
